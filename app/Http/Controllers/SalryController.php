...
class SalryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $total = ($user->basic_salary + $request->total_commission + $request->bonus + $request->security_clearance) - $request->advance_deduct - $holidaydeduct - $halfdaydeduct - $request->fine_deduct - $request->food_deduct - $request->security_deduct - $request->advance_deduct - $late_deduct;
